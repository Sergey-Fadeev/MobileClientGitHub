...
struct CommitElement: Codable {
    ...
    static var placeholder: CommitsJSONArray {
        return [CommitElement.init(sha: nil, nodeID: nil, commit: nil, url: nil, htmlURL: nil, commentsURL: nil, author: nil, committer: nil, parents: nil)]
    }
...
typealias CommitsJSONArray = [CommitElement]
